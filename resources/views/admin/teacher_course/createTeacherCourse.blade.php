...
@section('content')
    <div class="container">
        <h2 class="h2">新增老師的課程</h2>
        <form action="{{ url('/admin/teacherCourses') }}" method="post">
            @csrf
            <div class="form-group">
                <label for="teacher_id">老師編號</label>
                <input type="number" class="form-control" id="teacher_id" name="teacher_id" required="required" placeholder="請輸入老師編號">
            </div>
            <div class="form-group">
